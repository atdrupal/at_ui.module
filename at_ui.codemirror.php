...
{
    $menu['user/%user/devel']['page callback'] = $menu['user/%user/devel/render']['page callback'] = $menu['node/%node/devel']['page callback'] = $menu['node/%node/devel/render']['page callback'] = $menu['comment/%comment/devel']['page callback'] = $menu['comment/%comment/devel/render']['page callback'] = $menu['taxonomy/term/%taxonomy_term/devel']['page callback'] = $menu['taxonomy/term/%taxonomy_term/devel/render']['page callback'] = 'atdr';

    $menu['user/%user/devel']['page arguments'] = $menu['user/%user/devel/render']['page arguments'] = $menu['node/%node/devel']['page arguments'] = $menu['node/%node/devel/render']['page arguments'] = $menu['comment/%comment/devel']['page arguments'] = $menu['comment/%comment/devel/render']['page arguments'] = $menu['taxonomy/term/%taxonomy_term/devel']['page arguments'] = $menu['taxonomy/term/%taxonomy_term/devel/render']['page arguments'] = array(1);

    $menu['taxonomy/term/%taxonomy_term/devel']['page arguments'] = $menu['taxonomy/term/%taxonomy_term/devel/render']['page arguments'] = array(2);
